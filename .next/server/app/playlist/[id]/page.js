...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8181)), "C:\\code\\music-app\\src\\app\\playlist\\[id]\\page.jsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8276)), "C:\\code\\music-app\\src\\app\\not-found.jsx"],
    ...
    const pages = ["C:\\code\\music-app\\src\\app\\playlist\\[id]\\page.jsx"];
    ...
    const originalPathname = "/playlist/[id]/page"
...
const Playlists = async ({ params })=>{
    const { type, title, description, picture_medium, tracks } = await (0,_utils_fetchers__WEBPACK_IMPORTED_MODULE_3__/* .fetchPlaylist */ ._Y)(params.id);
...
var __webpack_exports__ = __webpack_require__.X(0, [106,875,289,775,963,745,874,609,245], () => (__webpack_exec__(9360)));
